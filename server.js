...
var mainDishesRouter = require('./routes/mainDishes');
var drinksRouter = require('./routes/drinks');
var dessertsRouter = require('./routes/desserts');
var appetizersRouter = require('./routes/appetizers');
...
app.use('/categories', mainDishesRouter);
app.use('/categories', drinksRouter);
app.use('/categories', dessertsRouter);
app.use('/categories', appetizersRouter);
